...
contract MetaDogeToken is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) > 0, 'Error: must own MDOGE to claim reward');
    ...
    function retrieveMainBalance(uint256 amount) public onlyOwner {
